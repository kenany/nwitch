...
function PluginManager(config, bot) {
  this.config = config;
  this.bot = bot;
}
...
PluginManager.prototype.load = function(file) {
  ...
  for (var key in commands) {
    ...
    this.addPluginCommand(bot, pluginName, command, func);
  }
};

PluginManager.prototype.reload = function(file) {
  var bot = this.bot;
