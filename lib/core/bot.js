...
var PluginManager = require('./manager');
...
/**
 * Loads default and user-installed plugins, spawns IRC client, joins channel,
 * and sets up message hooks.
 */
Bot.prototype.spawn = function() {
  ...
  // are added for a particular event. This is a useful default for finding
  // memory leaks.
  //
  // For nwitch, plugins will be adding their own listeners so the limit needs
  // to be increased as nwitch's popularity grows.
